...
export async function GET(req: Request) {
  try {
    ...
    const filePath = path.join(process.cwd(), "public","importonyperu", "images", "covers", fileName);
    ...
    return NextResponse.json({ success: true, filePath: `/importonyperu/images/covers/${fileName}` });
  } catch (error) {
